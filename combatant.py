...
MALE_FIRST_NAMES = ['Davey','Ken','Bobobo','The','Henry','Xavier','Jason','Moses', 'Jack','Barry','Shinji', \
            ...
            'Donovan', 'James', 'Henry', 'Liam', 'Yusuke', 'Uriel', 'Iggy', 'Ichi', 'Reginald', 'Kyle']
FEMALE_FIRST_NAMES = ['Xiao','Carey','Sung Mina', 'Jesse', 'Talulah', 'Mindy', 'Jessica', 'Sandra', 'Cortana', 'Alexa', \
            ...
            'Monique', 'Bibi', 'Arya', 'Sudharshanaa', 'Bon Qui Qui', 'The', 'Kendra', 'Kim', 'Juanita', 'Julia', \
            'Simone', 'Roxanne', 'Kaoru', 'Elena', 'Helen', 'Nicole', 'Nikki', 'Reina', 'Mimi']
